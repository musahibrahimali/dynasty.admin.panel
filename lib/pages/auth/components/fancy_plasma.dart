...
TimelineTween<_P> _createTween() {
  ...
  tween.addScene(end: (2 * musicUnitMs).round().milliseconds, duration: 1.milliseconds);

  return tween;
}

class PlasmaPart1 extends StatelessWidget {
  const PlasmaPart1({Key? key}) : super(key: key);
...
class PlasmaPart2 extends StatelessWidget {
  const PlasmaPart2({Key? key}) : super(key: key);
...
class PlasmaPart3 extends StatelessWidget {
  const PlasmaPart3({Key? key}) : super(key: key);
...
class PlasmaPart4 extends StatelessWidget {
  const PlasmaPart4({Key? key}) : super(key: key);
