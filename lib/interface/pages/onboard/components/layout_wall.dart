...
class LayoutWall extends StatelessWidget {
                ...
                child: Transform(
                  ...
                  child: Transform.scale(
                    ...
                    child: Transform.translate(
                      offset: Offset(value.get(_P.translateX), value.get(_P.translateY)),
                      child: OverflowBox(
  ...
  List<Widget> _createGrid(BuildContext context, Size size) {
    ...
    final itemSize = size.width > size.height ? size.width / 4 : size.height / 4;
...
TimelineTween<_P> _createTween(Size size) {
  ...
  tween
      .addScene(begin: musicUnitMs.milliseconds, duration: musicUnitMs.milliseconds)
